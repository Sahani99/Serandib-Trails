      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto">
            At **Ceylon Adventures**, we do not just book trips; we curate personal explorations of Sri Lanka’s soul. We are committed to authenticity, sustainability, and making every moment count.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
              Founded in **{new Date().getFullYear() - 10}**, we began as a small group of local travel enthusiasts frustrated by generic tourist itineraries. We believe the true magic of Sri Lanka lies off the beaten path—in a local s kitchen, a remote tea estate, or a hidden temple only the locals know.
            </p>
          ...
          <div className="order-1 lg:order-2 relative h-96 w-full rounded-2xl shadow-2xl overflow-hidden">
            ...
            <Image
              src="https://images.unsplash.com/photo-1541334787-21e6bd3ab135?auto=format&fit=crop&w=800&q=80" 
        ...
        <div className="mb-20">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 rounded-xl bg-blue-50 border-t-4 border-blue-600 shadow-md">
              ...
              <p className="text-gray-600 text-sm">Every itinerary is hand-crafted by Sri Lankan experts with unmatched local knowledge.</p>
            </div>
            <div className="text-center p-6 rounded-xl bg-red-50 border-t-4 border-red-600 shadow-md">
              ...
              <p className="text-gray-600 text-sm">We prioritize ethical practices and support small, community-run businesses.</p>
            </div>
            <div className="text-center p-6 rounded-xl bg-green-50 border-t-4 border-green-600 shadow-md">
              ...
              <p className="text-gray-600 text-sm">Licensed, insured, and committed to high-quality transport and accommodation standards.</p>
            </div>
            <div className="text-center p-6 rounded-xl bg-purple-50 border-t-4 border-purple-600 shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-2">24/7 Local Support</h3>
              <p className="text-gray-600 text-sm">We provide round-the-clock support from our operations base right here in Colombo.</p>
            </div>
          </div>
        </div>
